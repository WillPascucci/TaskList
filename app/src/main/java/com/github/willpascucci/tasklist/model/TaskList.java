...
public class TaskList {
    ...
    public static void setPriority(Task t1){
        ...
        float timeRemaining = (float) t1.getDeadline().getTime()-c.getTime().getTime();
        ...
        if ((timeRemaining/t1.elapsedTime) < 1.0){                         //less than half time left
            if ((timeRemaining/t1.elapsedTime) < 0.5) t1.priority += 40;   //less than quarter time left, increase priority
